...
export class Buttons extends React.PureComponent<Props> {
  componentDidMount() {
    utility.createColorPicker((color) =>
  ...
  render() {
    return (
      <div className="ubb-buttons" onClick={(e) => e.stopPropagation()}>
          ...
          switch (item.type) {
            ...
            case "fontSize":
              return (
                <div
                  key={tagName + tagIcon}
                  className="ubb-button ubb-button-fontSize"
                >
            ...
            case "color":
              return (
                <div
                  className="ubb-button ubb-button-color"
                  key={tagName + tagIcon}
                >
                  <div className={`fa ${tagIcon} ubb-button-icon`}></div>
                  <input id="color" />
        ...
        {this.props.isPreviewing ? null : (
          <>
            <button
              className="fa fa-undo ubb-button"
              type="button"
              title="撤销"
              onClick={this.props.undo}
            ></button>
            <button
              className="fa fa-repeat ubb-button"
              type="button"
              title="重做"
        ...
        <button
          className="fa fa-window-maximize ubb-button"
          type="button"
          title="切换预览"
          onClick={this.props.triggerIsPreviewing}
        ></button>
      </div>
    );
  }
