...
export default class Emoji extends React.Component<EmojiProps> {
  ...
  render() {
    ...
    const mohjong = {
      ...
      carton: [
        ...
        <LazyImage
          ...
          onClick={() => {
            this.insertEmoji("c:", item.slice(0, 3));
          }}
        ></LazyImage>
      )),
      ...
      face: new Array(208)
        ...
        .map((item, index) => {
          //处理后缀为gif的表情，o(1)......
          if (
            [4, 9, 56, 61, 62, 87, 115, 120, 137, 168, 169, 175, 206].indexOf(
              index + 1
            ) !== -1
          ) {
            return `${item}.gif`;
        ...
        .map((item) => (
          <LazyImage
            ...
            onClick={() => {
              this.insertEmoji("f:", item.slice(0, 3));
            }}
          ></LazyImage>
        )),
    };
    ...
    const info = {
      CC98: (
        <p className="ubb-emoji-info">
          该组表情由{" "}
          <a target="_blank" href="/user/id/567066">
            洛予
          </a>{" "}
          和{" "}
          <a target="_blank" href="/user/id/641262">
            大鲶鱼保佑
          </a>{" "}
          制作
        </p>
      ...
      ac: (
        <p className="ubb-emoji-info">
          该组表情由{" "}
          <a target="_blank" href="http://www.acfun.cn">
            AcFun弹幕视频网
          </a>{" "}
          提供
        </p>
      ...
      mj: (
        <p className="ubb-emoji-info">
          该组表情由{" "}
          <a target="_blank" href="//bbs.saraba1st.com/2b/forum.php">
            stage1st论坛
          </a>{" "}
          提供
        </p>
      ...
      tb: (
        <p className="ubb-emoji-info">
          该组表情由{" "}
          <a target="_blank" href="//tieba.baidu.com ">
            百度贴吧
          </a>{" "}
          提供
        </p>
      ...
      ms: (
        <p className="ubb-emoji-info">
          该组表情由{" "}
          <a target="_blank" href="https://www.maj-soul.com/">
            雀魂Majsoul
          </a>{" "}
          提供
        </p>
    ...
    return (
      <div
        ...
        style={
          emojiIsShown
            ? { height: `${this.props.height || 18}rem`, borderWidth: "1px" }
            : { height: "0rem" }
        }
      ...
      >
        <div className="ubb-emoji-buttons">
          <button
            ...
            className={
              emojiType === "CC98"
                ? "ubb-emoji-button-active"
                : "ubb-emoji-button"
            }
            onClick={(e) => {
              e.stopPropagation();
              this.props.changeEmojiType("CC98");
            }}
          >
            CC98
          </button>
        ...
        <div
          className={`ubb-emoji-content ubb-emoji-content-${emojiType}`}
          style={{ height: `${this.props.height || 16}rem` }}
        >
          {info[emojiType]}
          {emoji[emojiType]}
        </div>
