...
> {
  ...
  componentDidMount() {
    this.setState({
      boardId: this.props.topicInfo.boardId,
      topicId: this.props.topicId,
      boardName: this.props.boardInfo.name,
      title: this.props.topicInfo.title,
    });
  }
  componentWillReceiveProps(newProps) {
    this.setState({
      boardId: newProps.topicInfo.boardId,
      topicId: newProps.topicId,
      boardName: newProps.boardInfo.name,
      title: newProps.topicInfo.title,
    });
  }
  render() {
