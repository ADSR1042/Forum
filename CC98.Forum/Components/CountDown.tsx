        ...
        <p style={{ margin: 0 }}>
          ...
          {betweenTime.days > 0 ? (
            <span style={spanStyle}>
              <span style={color}>{betweenTime.days}</span>天
            </span>
          ) : null}
          {betweenTime.hours < 0 ? null : (
            <span style={spanStyle}>
              <span style={color}>{betweenTime.hours}</span>时
            </span>
          )}
          {betweenTime.minutes < 0 ? null : (
            <span style={spanStyle}>
              <span style={color}>{betweenTime.minutes}</span>分
            </span>
          )}
          {betweenTime.seconds < 0 ? null : (
            <span style={spanStyle}>
              <span style={color}>{betweenTime.seconds}</span>秒
            </span>
          )}
        </p>
      );
