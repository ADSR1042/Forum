...
export class MessageReceiver extends React.Component<MessageSendReceiveProps> {
  render() {
    ...
    return (
      <div className="message-message-wc">
        ...
        <div className="message-message-wcReceiver">
          <a href={userUrl} target="_blank">
            <img
              className="message-message-wcPortraitUrl"
              src={this.props.senderPortraitUrl}
            />
          </a>
          <div className="message-message-wcContent">
            <div className="message-message-wcText" id={String(this.props.id)}>
              <UbbContainer code={this.props.content} />
            </div>
          </div>
        </div>
      </div>
