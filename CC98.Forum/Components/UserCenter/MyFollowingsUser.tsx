  ...
  render() {
    return (
      <div className="user-center-myfollowings-user">
        ...
        <p>
          <span className="user-center-myfollowings-user-id">
            <Link to={`/user/id/${this.props.userFanInfo.id}`}>
              {this.props.userFanInfo.name}
            </Link>
          </span>
          帖数
          <span className="user-center-myfollowings-user-posts">
            {this.props.userFanInfo.postCount}
          </span>
          粉丝
          <span className="user-center-myfollowings-user-fans">
            {this.props.userFanInfo.fanCount}
          </span>
        </p>
        <button
        ...
        <Link to={`/message/message?id=${this.props.userFanInfo.id}`}>
          <button className="user-message" type="button">
            私信
          </button>
        </Link>
      </div>
