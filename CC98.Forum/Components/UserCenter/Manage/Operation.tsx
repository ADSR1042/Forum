    ...
    return (
      <div>
        ...
        <div className="user-manager">
          <p>OperationType: </p>
          <select
            value={this.state.ForumUserOperation.PunishmentType || 0}
            onChange={(e) => {
              this.handleForumUserOperationChange(
                "PunishmentType",
          ...
          <input
            type="text"
            onChange={(e) => {
              this.handleForumUserOperationChange("Reason", e.target.value);
            }}
            value={this.state.ForumUserOperation.Reason}
          />
          <p>Days: </p>
          <input
            type="number"
            ...
            value={this.state.ForumUserOperation.Days}
          />
          <button
            type="button"
            onClick={() => {
