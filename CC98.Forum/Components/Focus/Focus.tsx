        ...
        <Router>
          <div className="focus">
            <div className="focus-nav">
              <Link style={{ textDecoration: "none" }} to="/focus/board">
                {" "}
                <div className="focus-title" id="myFocusBoard">
                  关注版面
                </div>
              </Link>
              <Link style={{ textDecoration: "none" }} to="/focus/user">
                {" "}
                <div className="focus-title" id="myFocusUser">
                  关注用户
                </div>
              </Link>
              <Link style={{ textDecoration: "none" }} to="/focus/favorite">
                {" "}
                <div className="focus-title" id="myFocusFavorite">
                  收藏更新
                </div>
              </Link>
            </div>
